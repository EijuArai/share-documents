...
class RejectDocument(
    ...
    override fun call(): SignedTransaction {
        ...
        if (ourIdentity != inputState.consenter) {
            throw FlowException("Initiator should be consenter.")
        }
        ...
        val builder = TransactionBuilder(notary)
            ...
            .addCommand(DocumentContract.Commands.Reject(), participants.map { it.owningKey })
...
@InitiatedBy(RejectDocument::class)
class RejectDocumentResponder(val counterpartySession: FlowSession) : FlowLogic<SignedTransaction>() {
    @Suspendable
    override fun call(): SignedTransaction {
